...
(function (global) {
  ...
  const ICONES = {
    ...
    whatsapp: svg(
      ...
      '<path d="M24 20c-1 0-2 .4-2.6 1.4-.9 1.3-2 3-2 6s2.2 6 2.5 6.4c.3.4 4.3 7 10.7 9.5 5.3 2.1 6.4 1.7 7.6 1.6 1.2-.1 3.8-1.5 4.3-3s.6-2.8.4-3c-.2-.3-.6-.4-1.2-.7l-4.4-2.2c-.6-.3-1-.4-1.5.3l-2 2.6c-.4.5-.8.5-1.4.2-3.5-1.5-6-3.6-7.9-6.9-.4-.7 0-1 .3-1.4l1.1-1.4c.3-.5.2-.9 0-1.3l-2-4.9c-.5-1.2-1-1.2-1.5-1.2H24z" fill="#0c0a06"/>',
      '0 0 64 64'
    ),
    instagram: svg(
